# tests/test_acm2dscl_encryptor.py

import numpy as np
import pytest
from hypothesis import given, settings
from hypothesis.strategies import integers
import hypothesis.extra.numpy as hnp  # (not used directly, but handy if you extend)

import sys, os
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Adjust the import below to match your package layout
from encryption.acm_2dscl import Acm2dsclEncryptor

KEY = "k"
NONCE = "n"

def make_enc():
    # Your adapter has no tunables needed for tests
    return Acm2dsclEncryptor()
